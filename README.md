...
A skill that reviews, scores, and improves UI/UX designs against the design philosophy of
**[Kole Jain](https://www.youtube.com/@KoleJain)** — built only from his own resources (the free
Figma files at [kolejain.com/resources](https://www.kolejain.com/resources) + transcripts of his
top 24 videos). No app, no code, nothing to install or run; it's instructions an AI loads.
...
> **Bonus: a second, surgical skill is bundled in [`kole-component-polish/`](kole-component-polish/).**
> It fixes just the components you point at (or circle on a screenshot) instead of redesigning a whole
> screen, and shares this skill's references. To have it auto-trigger on its own, move the
> `kole-component-polish/` folder up so it sits beside this one in `~/.claude/skills/`; otherwise just
> point your AI at `kole-component-polish/SKILL.md` (or paste it).
...
## Credit & attribution
Independent, unofficial tool — built out of genuine appreciation for Kole's work, and **not
affiliated with or endorsed by Kole Jain.** All philosophy, principles, and the images in
`references/visual-examples/` come from his videos and published Figma resources; full credit to him.

- **YouTube:** https://www.youtube.com/@KoleJain
- **Resources / Figma files:** https://www.kolejain.com/resources
- **Instagram:** https://www.instagram.com/uiuxdailytips

If you're Kole and would like anything attributed differently or removed, please open an issue and it'll be done.
